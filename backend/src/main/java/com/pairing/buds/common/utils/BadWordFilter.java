package com.pairing.buds.common.utils;
...
public class BadWordFilter {
    ...
    public boolean isBadWord(String content){
        return Arrays.stream(badWords).parallel().anyMatch(badWord ->
                badWord.equalsIgnoreCase(content)
        );
    }
}
